  ...
  return (
    <div ref={ref} className="bg-white p-4 w-[80mm] text-slate-900 font-mono text-xs leading-tight">
      ...
      <div className="text-center mb-6 space-y-1">
        ...
        <p className="font-bold">{branch.tagline || 'Original Yemeni Taste'}</p>
      ...
      <div className="mb-4 space-y-1">
        ...
        {order.table_id && (
          <div className="flex justify-between">
            <span>Table:</span>
            <span className="font-bold">Table {order.table_id}</span>
          </div>
        )}
      </div>
      ...
      <div className="space-y-2 mb-6">
        ...
        <div className="flex justify-between text-base font-black border-t border-slate-200 pt-2">
          <span>TOTAL:</span>
          <span>{(order.total_amount || (subtotal + tax - (order.discount_amount || 0))).toFixed(2)} AED</span>
        </div>
      </div>
