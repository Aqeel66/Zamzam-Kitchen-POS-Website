...
class ReceiptService {
          ...
          return pw.Column(
            ...
            children: [
              ...
              if (phone.isNotEmpty || email.isNotEmpty)
                pw.Text(
                  '${phone.isNotEmpty ? "Tel: $phone" : ""} ${email.isNotEmpty ? " | $email" : ""}',
                  style: const pw.TextStyle(fontSize: 8),
                  textAlign: pw.TextAlign.center,
                ),
              ...
              pw.Text(
                isReservation ? 'BOOKING RECEIPT' : 'ORDER RECEIPT',
                style: pw.TextStyle(
                  fontSize: 12,
                  fontWeight: pw.FontWeight.bold,
                ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    DateFormat('dd/MM/yy HH:mm').format(orderTime),
              ...
              pw.Align(
                ...
                child: pw.Text(
                  'Cust: ${order['customer_name'] ?? 'Counter'}',
                  style: const pw.TextStyle(fontSize: 9),
                ),
              ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    '$currency${(double.tryParse(order['total_amount']?.toString() ?? '0') ?? 0.0).toStringAsFixed(2)}',
                    style: pw.TextStyle(
                      fontSize: 14,
                      fontWeight: pw.FontWeight.bold,
                    ),
              ...
              if ((double.tryParse(
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      '-$currency${(double.tryParse(order['discount_amount']?.toString() ?? '0') ?? 0.0).toStringAsFixed(2)}',
                      style: const pw.TextStyle(fontSize: 9),
                    ),
                  ],
                ),
              ...
              pw.Text(
                'Zamzam Kitchen Unified System v2.5.0',
                style: const pw.TextStyle(
                  fontSize: 6,
  ...
  static Future<Uint8List> generateInvoicePdf({
    ...
    final businessName =
        (tenant['business_name'] ?? tenant['name'] ?? 'Zamzam Kitchen')
            .toString()
            .toUpperCase();
    final businessAddress =
        tenant['business_address'] ?? tenant['address'] ?? '';
    ...
    final String primaryLogoUrl = ThemeService.resolveImageUrl(
      tenant['logo_url'] ?? '',
    );
    final String secondaryLogoUrl = ThemeService.resolveImageUrl(
      tenant['secondary_logo_url'] ?? branch['secondary_logo_url'] ?? '',
    );
            ...
            children: [
                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 10),
                      pw.Text(
                        isReservation ? 'BOOKING RECEIPT' : 'INVOICE',
                        style: pw.TextStyle(
                          fontSize: 28,
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColors.grey800,
                      ...
                      pw.Text(
                        'Date: ${DateFormat('dd MMM yyyy HH:mm').format(orderTime)}',
                        style: const pw.TextStyle(fontSize: 9),
                      ),
                    ],
                  ),
                  ...
                  pw.Container(
                    ...
                    child: pw.Column(
                      children: [
                        _buildTotalRow(
                          'Subtotal:',
                          '$currencyDisplay${(double.tryParse(order['total_amount']?.toString() ?? '0') ?? 0.0).toStringAsFixed(2)}',
                          fontSize: 10,
                        ),
                        if ((double.tryParse(
                                  order['discount_amount']?.toString() ?? '0',
                          ...
                          _buildTotalRow(
                            'Discount:',
                            '-$currencyDisplay${(double.tryParse(order['discount_amount']?.toString() ?? '0') ?? 0.0).toStringAsFixed(2)}',
                            fontSize: 10,
                            isDiscount: true,
                          ),
                        if ((double.tryParse(
                                  order['tip_amount']?.toString() ?? '0',
                                ) ??
                                0) >
                            0)
                          _buildTotalRow(
                            'Tip:',
                            '$currencyDisplay${(double.tryParse(order['tip_amount']?.toString() ?? '0') ?? 0.0).toStringAsFixed(2)}',
                            fontSize: 10,
                          ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    'Generated by Zamzam Kitchen Unified System v2.5.0',
                    style: const pw.TextStyle(
                      fontSize: 7,
                      color: PdfColors.grey500,
                    ),
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              fontSize: fontSize,
              color: isDiscount ? PdfColors.red900 : PdfColors.black,
            ),
          ),
          pw.Text(
            value,
