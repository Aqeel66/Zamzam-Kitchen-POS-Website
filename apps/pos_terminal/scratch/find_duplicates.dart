...
void main() {
  final file = File(
    'd:/Anti-Gravity Projects/Backups/IRM -Backup 4-5-26 1-28pm/apps/pos_terminal/lib/localization_service.dart',
  );
  ...
  for (int i = 0; i < lines.length; i++) {
    ...
    else if (line.contains("'Arabic': {"))
      currentLocale = 'Arabic';
    else if (line.contains("'Urdu': {"))
      currentLocale = 'Urdu';
